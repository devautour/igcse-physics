...
!!! warning "The Hazard: Fuel Ignition"
    1. Friction: Liquid fuel is an electrical insulator. As it pumps through delivery pipes at high speeds, friction between the fuel and the pipe walls transfers electrons.
    2. Charge Build-up: This causes a substantial static charge to build up on both the pipe nozzle and the aircraft's body.
    3. Explosion Risk: If unmanaged, a spark could jump between the fuel nozzle and the aircraft tank. Because fuel vapors are highly flammable, this spark can instantly ignite the vapor, causing a deadly explosion.
...
!!! abstract "The Solution: Earthing (The Bonding Line)"
    To eliminate this danger, a copper conductor called a bonding line is securely connected between the aircraft and the earth before any fuel lines are attached.

    The bonding line provides a low-resistance path for excess charge to flow safely to the ground. It is far easier for electrons to flow down the copper wire than to leap through the air, completely neutralizing the aircraft and preventing a dangerous potential difference from developing.

!!! tip "Examiner Tips and Tricks"
    When answering Edexcel exam questions on the dangers and management of static electricity, structure your response around these core checkpoints:

    * **Identify the Danger:** Clearly state what the structural risk is (e.g., a spark igniting flammable gas/vapors, or an electric shock).

    * **Explain the Transfer:** Explicitly state that charge builds up due to **friction** and specify that it is **electrons** moving, never positive charges.

    * **Detail the Solution (Earthing):** Explain that connecting a conductor (earth wire/bonding line) allows electrons to flow safely to or from the ground, ensuring the object is discharged/neutralized so no spark can occur.