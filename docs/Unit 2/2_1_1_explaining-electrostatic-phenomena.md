...
!!! abstract "Definition: Electric conductors and insulators"
    ...
    An electric **conductor** is a material that allows **charge** (usually electrons) to flow through it easily.<br>
    Examples of **conductors** are: metals (Silver, Copper, Aluminium, Steel ...), graphite, mineral water 

    An electric **insulator** is a material that does **not** allow the flow of **charge** through them very easily.<br>
