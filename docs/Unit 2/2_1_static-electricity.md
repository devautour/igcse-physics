...
Matter is made of atoms, which contain a nucleus made of **protons** and **neutrons** around which orbit **electrons**. TODO: sketch.
Protons all have the same **positive** charge ($+e = +1.60 \times 10^-19 \text{C}$) and neutrons are **neutral**, so the nucleus of an atom is always positive. **Electrons**, have a **negative** charge ($-e = -1.60 \times 10^-19 \text{C}$)
...
***The number of negative electrons in a neutral atom balances the number of positive protons***

When two charged particles or objects are close together, they exert a **force** on each other
...
![Diagram showing like charges repelling and opposite charges attracting](../assets/images/page_110_image_3_v2.jpg)
...
* The magnitude of the force is **stronger** if the objects are **closer together**
...
![Diagram showing the lattice structure of a conductor with positive metal ions and delocalised electrons. Labels include: ELECTRONS FROM OUTER SHELL OF METAL ATOMS, POSITIVELY CHARGED METAL IONS, and ELECTRONS ARE DELOCALISED; THEY ARE FREE TO MOVE THROUGHOUT THE STRUCTURE.](../assets/images/page_104_chart_1_v2.jpg)
...
!!! abstract "Principe of Conservation of Charge":
    The total charge is constant. 

Protons are strongly bonded inside the nucleus, but electrons are only loosely bonded to the nucleus, so the only way charged is transferred is if there is a transfer of electrons.
...
![Illustration of hands rubbing a polythene rod with a cloth](../assets/images/page_111_image_1_v2.jpg)
...
![Diagram showing the transfer of electrons from a plastic rod to a cloth through friction. The top part shows an uncharged cloth and an uncharged plastic rod. The bottom part shows the cloth after rubbing, now negatively charged with '-' signs, and the rod now positively charged with '+' signs.](../assets/images/page_112_image_1_v2.jpg)
...
![Diagram showing electron transfer between a duster and polythene/acetate rods. With the polythene rod, electrons move from the duster to the rod, making it negatively charged. With the acetate rod, electrons move from the rod to the duster, making it positively charged.](../assets/images/page_107_image_1_v2.jpg)
...
```mermaid
graph TD
    A[ORIGINAL DOCUMENT] --> B[Physics]
    B --> C[THE IMAGE OF THE DOCUMENT IS PROJECTED ONTO A POSITIVELY CHARGED COPYING PLATE]
    C --> D[WHERE LIGHT FALLS ONTO THE PLATE, THE ELECTRICAL CHARGE LEAKS AWAY]
    D --> E[NEGATIVELY CHARGED BLACK TONER PARTICLES ARE ATTRACTED TO THE REMAINING POSITIVE AREAS]
    E --> F[PAPER IS PLACED OVER THE COPYING PLATE: TONER IS TRANSFERRED TO THE PAPER AND HEATED TO MAKE IT STICK]
    F --> G[THE PHOTOCOPY IS TAKEN OFF THE COPY PLATE AND TURNED OVER TO REVEAL THE TEXT]
    G --> B
    subgraph THE PHOTOCOPIER
    end
```
...
![Diagram showing an insecticide sprayer emitting positively charged particles that repel each other to cover a large area.](../assets/images/page_114_chart_1_v2.jpg)
...
![Diagram of an aeroplane being refuelled with a bonding line connected to the earth. Text boxes explain: "FRICTION BETWEEN THE FUEL AND THE PIPES CAUSES STATIC CHARGE BUILD-UP" and "BONDING LINE CARRIES THE CHARGE TO THE EARTH TO REDUCE THE RISK OF SPARKS (AND A FIRE)"](../assets/images/page_115_image_1_v2.jpg)
