...
![Illustration of wind turbines in a field with ducks flying in the foreground](../assets/images/page_292_image_1_v2.jpg)
...
![Diagram of a hydroelectric dam showing water flowing from a reservoir through a water inlet to a turbine, which is connected to a generator in a powerhouse. Transmission lines carry electricity away, and water exits into a river stream.](../assets/images/page_293_image_1_v2.jpg)
...
![Diagram showing how tidal power works with a barrage and turbine during tide coming in and tide going out.](../assets/images/page_294_image_1_v2.jpg)
...
![Diagram showing a wave power turbine in the ocean with the label "WAVES TURN TURBINE"](../assets/images/page_295_image_2_v2.jpg)
...
![Diagram of a geothermal power plant showing "GEOTHERMAL ENERGY", "STEAM", "TURBINE & GENERATOR", "HOT WATER", "COOLING TOWER", and "INJECTION WELL"](../assets/images/page_295_image_1_v2.jpg)
...
![Diagram of a solar heating system showing a solar panel connected to a solar controller, hot water cylinder, and boiler, providing hot water to a bathtub.](../assets/images/page_296_image_1_v2.jpg)
...
![Illustration of solar panels under the sun with clouds](../assets/images/page_297_image_1_v2.jpg)
...
```mermaid
graph LR
    A[CHEMICALENERGYSTORE] --> B[THERMALENERGYSTORE]
    B --> C[KINETICENERGYSTORE]
    C --> D[KINETICENERGYSTORE]
    D --> E[TRANSFERREDAWAYELECTRICALLY]
    E --> F[ ]
```
...
!!! example "Electricity can be generated by wind power."
...
* Produces carbon dioxide (CO<sub>2</sub>), which contributes to global warming
...
* Produces no greenhouse gases or CO<sub>2</sub> during electricity generation
...
* The CO<sub>2</sub> released from combustion is balanced by the CO<sub>2</sub> absorbed in photosynthesis, so could be considered carbon neutral

#### Disadvantages of biofuels:

* Crops grown for biofuels compete with food crops for land and resources

* Combustion still releases CO<sub>2</sub> at the point of use
...
* Produces no greenhouse gases or CO<sub>2</sub> during operation
