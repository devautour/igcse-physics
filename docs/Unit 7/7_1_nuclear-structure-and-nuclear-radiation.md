...
* They are incredibly small, with a radius of only 1 × 10<sup>-10</sup> m
...
![Carbon 12 in nuclear notation diagram](../assets/images/page_415_image_2_v2.jpg)
...
!!! example "Worked Example"
    ...
    ![Diagram of a carbon-12 nucleus showing protons (P) and neutrons (N)](../assets/images/page_415_image_1_v2.jpg)
    ...
    * Therefore there must be **6** electrons in the carbon atom
    ...
    > ![lightbulb icon](../assets/images/page_416_image_1_v2.jpg) **Examiner Tips and Tricks** >
    > 
...
```mermaid
graph TD
    MN[MASS NUMBERPROTONS + NEUTRONS] --> H_top[2]
    MN --> Na_top[23]
    MN --> U_top[235]
    
    AN[ATOMIC NUMBERNUMBER OF PROTONS] --> H_bot[1]
    AN --> Na_bot[11]
    AN --> U_bot[92]

    subgraph Hydrogen_Atom
        H_top
        H_bot
        H[H]
    end
    
    subgraph Sodium_Atom
        Na_top
        Na_bot
        Na[Na]
    end
    
    subgraph Uranium_Atom
        U_top
        U_bot
        U[U]
    end

    Hydrogen_Atom --- HY[HYDROGEN]
    Sodium_Atom --- SO[SODIUM]
    Uranium_Atom --- UR[URANIUM]
```
...
![Diagram showing the atomic nuclei of Carbon-12 and Carbon-14. Carbon-12 is shown as a stable cluster of protons and neutrons. Carbon-14 is shown with two extra neutrons indicated by arrows and a label "EXTRA NEUTRONS".](../assets/images/page_421_chart_1_v2.jpg)
...
![Diagram showing an unstable nucleus emitting radiation](../assets/images/page_422_chart_1_v2.jpg)
...
* The symbol for beta is **β<sup>−</sup>**
...
<table>
  ...
  <tbody>
    <tr>
        <td><img src="page_423_image_5_v2.jpg" alt="Alpha particle diagram"></td>
        <td><img src="page_423_image_4_v2.jpg" alt="Beta particle diagram"></td>
        <td><img src="page_423_image_4_v2.jpg" alt="Gamma ray wave diagram"></td>
    </tr>
    <tr>
        <td>2 PROTONS<br/>2 NEUTRONS</td>
        <td>ELECTRON</td>
        <td>EM WAVE</td>
    </tr>
  </tbody>
...
![Diagram showing alpha decay: a parent nucleus emits an alpha particle (helium nucleus) and becomes a daughter nucleus. Legend indicates blue circles are neutrons and red circles are protons.](../assets/images/page_431_chart_1_v2.jpg)
...
* Where:
    ...
    - ${^A_Z}X$ is the initial element X with mass number A and atomic number Z

    - ${^{A-4}_{Z-2}}Y$ is the new element Y

*   $^{4}_{2}\alpha$ is an alpha particle
...
*   Where:
    ...
    *   $^{A}_{Z}X$ is the initial element X with mass number A and atomic number Z

    *   $^{A}_{Z+1}Y$ is the new element Y

    *   $^{0}_{-1}\beta$ is a beta particle
...
![Diagram showing a nucleus emitting a gamma ray represented by a wave packet](../assets/images/page_433_image_1_v2.jpg)
...
* Where:
    ...
    - ${^A_Z}X$ is the element X with mass number A and atomic number Z

    - ${^0_0}\gamma$ is a gamma ray
...
*   $^{A}_{Z}X$ is the element X with mass number A and atomic number Z
...
![Apparatus diagram showing Geiger counter, Geiger-Müller tube, radiation source in safe storage, tongs, and absorbers like paper, thin aluminium, and thick lead.](../assets/images/page_428_image_1_v2.jpg)
...
* If the count rate reduces when a **few mm of aluminium** is present, then the source is emitting **beta** * If some radiation is **still able to penetrate** a few mm of **lead**, then the source is emitting **gamma**

![Diagram showing the penetrating power of alpha, beta, and gamma radiation. Alpha particles are stopped by paper, beta particles are stopped by aluminium foil, and gamma rays are partially stopped by thick lead.](../assets/images/page_429_image_1_v2.jpg)
