...
!!! note "Required formulae: speed from a distance-time graph"
    ...
    ![Distance-time graph showing a straight line with a gradient triangle. The horizontal side is labeled Δx and the vertical side is labeled Δy. A box indicates GRADIENT = Δy / Δx.](../assets/images/page_4_image_1_v2.jpg)
...
![Velocity-time graph showing a red straight line with a positive gradient, starting low and ending high, representing increasing velocity, and a green straight line with a negative gradient, starting high and ending low, representing decreasing velocity.](../assets/images/velocity_time_graph_increasing_decreasing.svg)
...
![Velocity-time graph showing one continuous journey in three phases: an upward-sloping straight line representing constant acceleration, followed by a flat horizontal line representing constant velocity, followed by a downward-sloping straight line back to zero representing constant deceleration.](../assets/images/velocity_time_graph_phases.svg)
...
!!! note "Required formulae: acceleration from a velocity-time graph"
    ...
    ![Velocity-time graph showing gradient calculation with Δy and Δx](../assets/images/page_22_image_1_v2.jpg)
...
!!! note "Practical skill: finding distance travelled from a velocity-time graph"
    ...
    ![Diagram showing a velocity-time graph with shaded areas for a triangle and a rectangle. The triangle area is labeled "1/2 x BASE x HEIGHT" and the rectangle area is labeled "BASE x HEIGHT". A box indicates "DISTANCE = AREA".](../assets/images/page_25_image_1_v2.jpg)
    ...
    **Enclosed** areas under velocity-time graphs represent **total displacement** (or **total distance travelled**) in a time interval.
    ...
    ![Velocity-time graph showing three shaded areas: Area 1 (triangle), Area 2 (rectangle), and Area 3 (triangle)](../assets/images/page_26_chart_2_v2.jpg)
