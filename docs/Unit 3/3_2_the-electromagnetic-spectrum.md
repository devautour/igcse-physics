...
* Additionally, they are all **transverse**
...
* Wavelength and frequency are **inversely proportional** to each other:
    ...
    * This is explained by the [Wave equation](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/3-waves/3-1-waves-and-the-electromagnetic-spectrum/3-1-3-the-wave-equation/)
...
<table>
  ...
  <tbody>
    <tr>
        <td>RED</td>
        <td>[Visual: Red wave with longest wavelength]</td>
    </tr>
    <tr>
        <td>ORANGE</td>
        <td>[Visual: Orange wave]</td>
    </tr>
    <tr>
        <td>YELLOW</td>
        <td>[Visual: Yellow wave]</td>
    </tr>
    <tr>
        <td>GREEN</td>
        <td>[Visual: Green wave]</td>
    </tr>
    <tr>
        <td>BLUE</td>
        <td>[Visual: Blue wave]</td>
    </tr>
    <tr>
        <td>INDIGO</td>
        <td>[Visual: Indigo wave]</td>
    </tr>
    <tr>
        <td>VIOLET</td>
        <td>[Visual: Violet wave with shortest wavelength]</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
        <td>X-rays</td>
        <td>Observing the internal structure of objects and materials, including medical<br/>applications</td>
    </tr>
    <tr>
        <td>Gamma rays</td>
...
* Transport signals through fibre optic cables
...
* It is used in **photography**, where light is focused onto a sensor or film to produce an image
...
* When certain substances are exposed to ultraviolet light, they absorb it and re-emit it as visible light (making them glow)
...
```mermaid
graph TD
    Title[THE ELECTROMAGNETIC SPECTRUMSUMMARY OF USES AND DANGERS]
    ...
    RW --- RW_Info[USE: USED FOR LONG-RANGE COMMUNICATIONSREASON: BECAUSE THEY CAN BE REFLECTED FROM THE EARTH'S ATMOSPHERE]
    
    MW --- MW_Info[USE: SATELLITE COMMUNICATIONSREASON: BECAUSE MICROWAVES CAN PENETRATE EARTH'S ATMOSPHERE]
    
    IR --- IR_Info[USE: OPTICAL FIBRE COMMUNICATIONREASON: BECAUSE THEY CAN UNDERGO TOTAL INTERNAL REFLECTION]
    
    VL --- VL_Info[USE: TAKING PHOTOS AND VIDEOSREASON: CAMERAS ARE SET UP TO DETECT VISIBLE LIGHT]
    
    UV --- UV_Info[USE: FOR DETECTING SECURITY INKREASON: BECAUSE IT FLUORESCES WITH ULTRAVIOLET LIGHTING]
    
    XR --- XR_Info[USE: TO PHOTOGRAPH BONESREASON: BECAUSE X-RAYS CAN PENETRATE SOFT TISSUES BUT NOT BONE]
    
    GR --- GR_Info[USE: TO STERILISE MEDICAL TOOLSREASON: BECAUSE GAMMA KILLS BACTERIA]

    D1[DANGER: HIGH INTENSITY MICROWAVES CAN CAUSE HEATING OF INTERNAL ORGANSREASON: WATER MOLECULES ABSORB MICROWAVES STRONGLY]
    
    D2[DANGER: GAMMA X-RAYS AND HIGH INTENSITY UV CAN HARM CELLS AND CAUSE CANCERREASON: THEY ARE HIGHLY IONISING DUE TO HAVING A LOT OF ENERGY]
```
...
![Illustration of radiation badges, showing a closed badge and an open badge with internal compartments](../assets/images/page_195_image_6_v2.jpg)
