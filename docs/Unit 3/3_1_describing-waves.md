...
* Transverse waves:
    ...
    * can exist as e[lectromagnetic waves](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/3-waves/3-1-waves-and-the-electromagnetic-spectrum/3-1-5-electromagnetic-em-waves/) which can move in solids, liquids, gases and in a **vacuum**
...
![Diagram showing a transverse wave with a hand moving a rope up and down. Labels include: VIBRATION AT 90° TO ENERGY TRANSFER, WAVE MOTION AND ENERGY TRANSFER, WAVE PEAK, and WAVE TROUGH.](../assets/images/page_171_chart_1_v2.jpg)
...
![Diagram of a longitudinal wave in a slinky spring showing vibration, rarefaction, compression, and wave motion and energy transfer.](../assets/images/page_172_image_1_v2.jpg)
...
* Wave vibrations can be shown on **ropes** (transverse) and **springs** (longitudinal) ## A comparison of longitudinal and transverse waves

```mermaid
graph TD
    subgraph Transverse_Wave [VIBRATION IN ROPES]
        T1[WAVE TRAVEL PERPENDICULAR TO VIBRATION OF ROPE]
        T2[MOVEMENT OF ENERGY]
        T3[VIBRATION OF ROPE]
    end
    subgraph Longitudinal_Wave [VIBRATION IN SPRINGS]
        L1[WAVE TRAVEL PARALLEL TO THE VIBRATION OF COILS]
        L2[MOVEMENT OF ENERGY]
        L3[VIBRATION OF COILS]
    end
```
...
!!! example "Worked Example"
    ...
    ![Diagram of a loudspeaker with sound waves travelling to the right and a dust mote labelled D](../assets/images/page_174_image_1_v2.jpg)
    ...
    ??? npote "Answer :"
        ...
        **Step 2: Draw arrows at the point labelled D to show it vibrating in parallel to the direction of the sound waves**
        ...
        ![Diagram of a loudspeaker producing sound waves, showing an air particle 'D' vibrating back and forth.](../assets/images/page_175_image_2_v2.jpg)
...
![Illustration of a toy duck on water waves. An arrow shows the duck moving up and down perpendicular to the wave direction.](../assets/images/page_175_chart_1_v2.jpg)
...
![Diagram showing a wave moving to the right, drawn as a series of wavefronts. The diagram is titled "VIEWING WAVES FROM ABOVE" and labels the vertical lines as "WAVEFRONTS". A blue arrow points to the right.](../assets/images/page_178_chart_1_v2.jpg)
...
![Diagram of a wave showing displacement (y-axis) against distance of wave travel (x-axis). Wavelength (λ) is marked between two consecutive peaks. Amplitude (A) is marked from the equilibrium position to a peak.](../assets/images/page_179_chart_1_v2.jpg)
...
* Period is given the symbol *T* and is measured in **seconds (s)**
    ...
    - The equation linking frequency and time period is explained in [Frequency & time](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/3-waves/3-1-waves-and-the-electromagnetic-spectrum/3-1-3-the-wave-equation/) period
...
![Line chart showing a wave with displacement (x) on the y-axis and time on the x-axis. A horizontal double-headed arrow between two consecutive peaks is labeled "TIME PERIOD (T)".](../assets/images/page_180_chart_1_v2.jpg)


*Diagram showing the time period of a wave*

![Lightbulb icon](../assets/images/page_180_image_1_v2.jpg)
...
* All waves obey the **wave [speed](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/1-forces-and-motion/1-1-movement-and-position/1-1-2-speed/) equation**
...
!!! note "Formula triangle for the wave speed equation"
...
* **Frequency** and **time period** are defined in [Describing wave motion](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/3-waves/3-1-waves-and-the-electromagnetic-spectrum/3-1-2-describing-wave-motion/)
...
- $T$ is time period, measured in seconds (s)
...
!!! Example "Worked Example"
    ...
    ??? note "Answer :"
        ...
        **Step 3: Substitute the known values into the equation and calculate the time period**
        ...
        - Therefore, it takes **$1.67 \times 10^{-15}$ s** (to 2 decimal places) for one wave of visible light to pass our eyes

### Calculations in different contexts

- The **wave equation** can be applied and rearranged to calculate the properties of [Transverse and longitudinal waves](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/3-waves/3-1-waves-and-the-[electromagnetic](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/3-waves/3-1-waves-and-the-electromagnetic-spectrum/3-1-5-electromagnetic-em-waves/)-spectrum/3-1-1-transverse-and-longitudinal-waves/)

- The wave equation applies to all types of waves, including [Sound](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/3-waves/3-3-sound/3-3-1-core-practical-investigating-the-speed-of-sound/) waves and Electromagnetic waves
...
!!! Example "Worked Example"
    ...
    ??? note "Answer :"
        ...
        * Therefore, the speed of these radio waves is **$3 \times 10^8 \text{ m/s}$**
...
!!! tip "Examiner Tips and Tricks"
    ...
    Likewise, watch out for the frequency given in kHz: $1 \text{ kHz} = 1000 \text{ Hz}$
...
![Diagram showing a stationary police car emitting sound waves symmetrically in concentric circles](../assets/images/page_185_image_1_v2.jpg)
...
![Diagram showing the Doppler effect with a stationary and a moving police car. For the stationary car, wavelength is constant. For the moving car, wavelength appears larger to an observer behind and smaller to an observer in front.](../assets/images/page_186_image_1_v2.jpg)
