...
* Visible light is a part of the [Electromagnetic spectrum](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/3-waves/3-1-waves-and-the-electromagnetic-spectrum/3-1-5-electromagnetic-em-waves/) which means it is a **transverse wave**
...
* In optics the word **medium** is used to describe a material that transmits light (**Media** means more than one medium)

** An example of reflection **

![Illustration of a tree reflected in a body of water at night under a starry sky](../assets/images/page_199_image_1_v2.jpg)
...
![Diagram showing refraction of a light ray moving from air into water, changing direction at the boundary.](../assets/images/page_200_chart_1_v2.jpg)
...
![Ray diagram of reflection in a plane mirror showing incident ray, reflected ray, normal, angle of incidence (i), and angle of reflection (r).](../assets/images/page_200_image_1_v2.jpg)
...
*   A **reflected** ray has an arrow pointing **away** from the boundary ## A diagram showing the law of reflection

![Diagram showing the law of reflection with incident ray, reflected ray, normal, boundary, angle of incidence (i), and angle of reflection (r)](../assets/images/page_201_image_1_v2.jpg)
...
![Diagram of a ray refracted into and out of a glass block showing angle of incidence (i) and angle of refraction (r)](../assets/images/page_201_image_2_v2.jpg)

!!! example "Ray diagram showing the refraction of light as it passes through a rectangular block"
...
* To investigate the refraction of light using transparent rectangular blocks, semi-circular blocks and triangular prisms
    ...
    - To review your understanding of refraction use the revision note [Reflection &](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/3-waves/3-2-reflection-and-refraction/3-2-2-reflection-and-refraction/) refraction
...
<table>
  ...
  <tbody>
    <tr>
        <td>Ray Box</td>
        <td>To provide a narrow beam of light that can<br/>be easily refracted</td>
    </tr>
    <tr>
        <td>Protractor</td>
        <td>To measure the angles of incidence and<br/>refraction</td>
    </tr>
    <tr>
        <td>Sheet of Paper</td>
        <td>To mark the lines indicating the incident<br/>and refracted rays</td>
    </tr>
    <tr>
        <td>Pencil</td>
        <td>To draw the incident and refracted ray<br/>lines onto the paper</td>
    </tr>
    <tr>
        <td>Ruler</td>
        <td>To draw the incident and refracted ray<br/>lines onto the paper</td>
    ...
    <tr>
        <td>Perspex blocks (rectangular block, semi-<br/>circular block &amp; prism)</td>
...
![Diagram showing the apparatus for a refraction experiment, including a light box, transparent block on a sheet of paper, and drawn pencil lines.](../assets/images/page_204_image_1_v2.jpg)
...
![Diagrams showing refraction of light through semi-circular, rectangular, and prism blocks, including critical angle, no refraction, and dispersion of white light.](../assets/images/page_205_image_3_v2.jpg)
...
* Use the laws of refraction to analyse these results
    ...
    - You can use the revision note R[eflection & refraction](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/3-waves/3-2-reflection-and-refraction/3-2-2-reflection-and-refraction/) to do this
...
!!! note "A formula triangle can help rearrange the snell's law equation"

    ![Snell's law formula triangle diagram showing Angle of Incidence (Sin i) at the top, and Refractive Index (n) and Angle of Refraction (Sin r) at the bottom.](../assets/images/page_207_chart_1_v2.jpg)
...
![Diagram showing the apparatus set-up to investigate Snell's Law, including a light box, glass block on a sheet of paper, and rays entering and leaving the block.](../assets/images/page_211_image_1_v2.jpg)
...
![A diagram showing light rays passing through a rectangular block, with angles of incidence (20°, 40°, 60°) and corresponding angles of refraction labeled relative to the normal.](../assets/images/page_212_image_1_v2.jpg)

* [Snell's Law](https://www.savemyexams.com/igcse/physics/edexcel/19/revision-notes/3-waves/3-2-reflection-and-refraction/3-2-4-snells-law/) relates the angles of incidence and refraction
...
![Diagram showing refraction, critical angle, and total internal reflection of light rays moving from water to air.](../assets/images/page_214_image_1_v2.jpg)
...
![Diagram showing a light ray undergoing total internal reflection inside a curved optical fibre. The ray reflects off the internal boundaries, with one point labeled with angles i and r.](../assets/images/page_215_image_1_v2.jpg)
...
```mermaid
graph TD
    subgraph Endoscope_Detail [Endoscope Detail]
        A[EYEPIECE LENS] --- B((Eye))
        C[IMAGE OF OBJECT] --- B
        D[LIGHT FROM SOURCE] --- E(Optical Fibres)
        F[REFLECTED LIGHT FROM OBJECT] --- E
        G[OBJECTIVE LENS] --- H((Object))
        I[OPTICAL FIBRES] --- E
        J[PROTECTIVE SHEATH] --- E
        K[LIGHT FROM LIGHT SOURCE] --- D
    end

    subgraph Endoscopy_Procedure [Endoscopy Procedure]
        L[IMAGE IS VIEWED THROUGH EYEPIECE LENS] --- M((Eye))
        N[OESOPHAGUS] --- O((Body))
        P[STOMACH] --- O
        Q[IMAGE OF STOMACH LINING IS SEEN THROUGH AN OBJECTIVE LENS] --- R((Stomach Lining))
    end
```
...
![Diagram of a periscope showing light rays reflecting through two right-angled prisms](../assets/images/page_217_image_1_v2.jpg)
...
![Diagram showing single and double reflection through right-angled prisms. The left prism shows a single reflection at 90 degrees, and the right prism shows a double reflection at 180 degrees.](../assets/images/page_218_image_2_v2.jpg)
...
![Diagrams showing refraction, the critical angle, and total internal reflection in a semi-circular glass block.](../assets/images/page_219_image_1_v2.jpg)
...
!!! example "Worked Example"
    ...
    ![Diagram of a light ray entering a glass cube from air at 39 degrees, refracting at 25 degrees, and hitting a liquid boundary at point X.](../assets/images/page_219_chart_1_v2.jpg)
    ...
    ??? note "Answer :"
        ...
        * When a light ray is reflected, the angle of incidence = angle of reflection * Therefore, the angle of incidence (or reflection) is 90° – 25° = 65°
        ...
        * Therefore, 65° is the critical angle
        ...
        ![Diagram showing a light ray entering a glass cube from air, reflecting at a glass-liquid boundary at point X, and exiting back into air. Angles of 39°, 25°, and 65° are labeled relative to the normal lines.](../assets/images/page_220_chart_1_v2.jpg)
...
!!! example "Worked Example"
    ...
    ??? note "Answer :"
        ...
        * Refractive index of opal, n<sub>o</sub> = 1.5

        * Refractive index of diamond, n<sub>d</sub> = 2.4

        **Step 2: Write out the equation relating critical angle and refractive index**

        $$ \sin c = \frac{1}{n} $$

        **Step 3: Calculate the critical angle of opal (c<sub>o</sub>)**

        $$ \sin(c_o) = \frac{1}{1.5} = 0.6667 $$

        $$ c_o = \sin^{-1}(0.6667) = 41.8 = 42^\circ $$

        **Step 4: Calculate the critical angle of diamond (c<sub>d</sub>)**
        ...
        * The critical angle of diamond is **lower** than the critical angle of opal (c<sub>o</sub>>c<sub>d</sub>)
...
!!! tip "Examiner Tips and Tricks"
    ...
    * Then use the **inverse** sin function (sin<sup>-1</sup>) to find the value of c